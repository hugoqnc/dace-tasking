...
@dace.program
def build_up_b(rho: dace.float64, dt: dace.float64, dx: dace.float64, dy: dace.float64, u: dace.float64[ny, nx],
               v: dace.float64[ny, nx]):
    b = np.zeros_like(u)
...
@dace.program
def dace_channel_flow(nit: dace.int64, u: dace.float64[ny, nx], v: dace.float64[ny,
                                                                                nx], dt: dace.float64, dx: dace.float64,
                      dy: dace.float64, p: dace.float64[ny, nx], rho: dace.float64, nu: dace.float64, F: dace.float64):
    udiff = 1.0
    stepcount = 0
